...
function App() {
  ...
  const renderDualUserFeatures = () => (
    <div className="space-y-8">
      {/* Premium Zone */}
      <div>
        <h2 className="fs-2 fw-bold text-dark mb-4 d-flex align-items-center gap-3">
      ...
      <div>
        <h2 className="fs-2 fw-bold text-dark mb-4 d-flex align-items-center gap-3">
          <div className="bg-gradient-cyan-teal p-2 rounded-xl">
  ...
  return (
    <div className="min-vh-100 bg-gradient-gray-cyan-blue">
      {/* Header */}
      <header className="bg-white bg-opacity-80 backdrop-blur border-bottom border-light sticky-top">
        <div className="container-fluid">
          <div className="d-flex justify-content-between align-items-center" style={{height: '4rem'}}>
            <div className="d-flex align-items-center gap-3">
              ...
              <h1 className="fs-2 fw-bold text-gradient-cyan mb-0">
                ScholarHat LMS
              </h1>
            </div>
            ...
            <div className="d-flex align-items-center gap-4">
              ...
              <div className="d-flex align-items-center gap-2">
                <img 
                  src={mockUser.avatar} 
                  alt={mockUser.name}
                  className="w-8 h-8 rounded-circle object-cover"
                />
                <span className="small fw-medium text-dark">{mockUser.name}</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <footer className="bg-white border-top border-light mt-5">
            ...
            <div className="row g-4">
              <div className="col-md-6">
                <div className="d-flex align-items-center gap-3 mb-4">
                  ...
                  <h3 className="fs-4 fw-bold text-gradient-cyan mb-0">
                    ScholarHat LMS
                  </h3>
                </div>
              ...
              <div className="col-md-3">
                <h4 className="fw-semibold text-dark mb-4">Quick Links</h4>
                <ul className="list-unstyled space-y-2">
                  <li><a href="#" className="text-decoration-none text-muted small">About Us</a></li>
                  <li><a href="#" className="text-decoration-none text-muted small">Courses</a></li>
                  <li><a href="#" className="text-decoration-none text-muted small">Live Training</a></li>
                  <li><a href="#" className="text-decoration-none text-muted small">Certification</a></li>
                </ul>
              </div>
              
              <div className="col-md-3">
                <h4 className="fw-semibold text-dark mb-4">Support</h4>
                <ul className="list-unstyled space-y-2">
                  <li><a href="#" className="text-decoration-none text-muted small">Help Center</a></li>
                  <li><a href="#" className="text-decoration-none text-muted small">Contact Us</a></li>
                  <li><a href="#" className="text-decoration-none text-muted small">Privacy Policy</a></li>
                  <li><a href="#" className="text-decoration-none text-muted small">Terms of Service</a></li>
                </ul>
              </div>
            </div>
            
            <div className="mt-4 pt-4 border-top border-light text-center small text-muted">
